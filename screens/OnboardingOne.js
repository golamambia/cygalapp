...
const OnboardingOne = ({ navigation }) => {
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={{flex:1}}>
                    ...
                    <View style={styles.flewOne}>
                        ...
                        <Image style={styles.image} source={require("../assets/images/onboardingone.png")} />
                        </View>
                    </View>
                    <View style={styles.flewTwo}>
                        <View style={styles.flextwoView}>

                            <Text style={styles.flextwoText}>Find the hottest styles from Brands you love</Text>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('OnboardingTwo')} style={styles.flexthreeTouch}>
